...
(function() {
  ...
  Migrator = (function() {
    ...
    Migrator.prototype._runWhenReady = function(migrations, direction, cb, progress) {
      ...
      onSuccess = (function(_this) {
        return function() {
          ...
          return _this._coll().find().toArray(function(err, docs) {
            ...
            return _this._run(migrations, direction, cb, progress);
          });
        };
      })(this);
    ...
    Migrator.prototype._run = function(migrations, direction, done, progress) {
      var allDone, handleMigrationDone, i, l, log, logFn, migrationContext, migrationsCollection, migrationsCollectionUpdatePromises, ranMigrations, result, runOne, systemLog, timeout, userLog;
      result = {};
      logFn = this.log;
      log = function(src) {
        return function(msg) {
      ...
      ranMigrations = this._ranMigrations;
      migrationContext = {
        db: this._db,
        log: userLog
      };
    ...
    Migrator.prototype.migrate = function(done, progress) {
      ...
      this._runWhenReady(this._m, 'up', _done, progress);
    };
    ...
    Migrator.prototype.rollback = function(done, progress) {
      ...
      this._runWhenReady(migrations, 'down', done, progress);
    };
