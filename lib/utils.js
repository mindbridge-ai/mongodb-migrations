...
(function() {
  var DEFAULT_COLLECTION, DEFAULT_POOL_SIZE, MongoClient, _, _buildOptions, fs, mkdirp, path, urlBuilder, validateConnSettings;
  ...
  exports.loadMigrationsFromDir = function(dir, cb) {
