...
describe("Utils", () => {
    ...
    describe("normalizeConfig", () => {
        ...
        it("should throw with wrong replicaset 1", () => {
            ...
            ).toThrow("`replicaset` is not an object");
        });
        ...
        it("should throw with wrong replicaset 2", () => {
            ...
            ).toThrow("`replicaset.name` is not set");
        });
        ...
        it("should throw with wrong replicaset 3", () => {
            ...
            ).toThrow("`replicaset.members` is not set or is not an array");
        });
        ...
        it("should throw with wrong replicaset 5", () => {
            ...
            ).toThrow("each of `replicaset.members` must have `host` set");
        });
